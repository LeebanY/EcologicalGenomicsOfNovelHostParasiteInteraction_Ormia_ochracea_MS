...
CALI=PBStest/populations/California.txt
...
vcftools --gzvcf $VCF1 --keep $CALI --TajimaD 10000 --out $outdir/Cali_CHR1
vcftools --gzvcf $VCF2 --keep $CALI --TajimaD 10000 --out $outdir/Cali_CHR2
vcftools --gzvcf $VCF3 --keep $CALI --TajimaD 10000 --out $outdir/Cali_CHR3
vcftools --gzvcf $VCF4 --keep $CALI --TajimaD 10000 --out $outdir/Cali_CHR4
vcftools --gzvcf $VCF5 --keep $CALI --TajimaD 10000 --out $outdir/Cali_CHR5
