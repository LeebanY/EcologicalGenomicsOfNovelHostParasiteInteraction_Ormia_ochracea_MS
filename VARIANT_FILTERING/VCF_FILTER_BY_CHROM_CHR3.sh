...
VCF_CHR3=OrmiaHawaiiAllSitesBcftools.CHR3.vcf.gz
...
OUT_CHR3=FilteredOrmiaAllSitesBcftools.CHR3.vcf.gz
...
bcftools view --threads 16 -M 2 -i 'MIN(INFO/MQ)>30 && MIN(INFO/DP)>10' $VCF_CHR3 | sed 's/ENA|OY727107|OY727107\.1/chr3/g' | bgzip -c > $OUT_CHR3
