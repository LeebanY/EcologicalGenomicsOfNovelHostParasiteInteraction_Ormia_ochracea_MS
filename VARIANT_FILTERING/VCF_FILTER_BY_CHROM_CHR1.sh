...
#SBATCH --output=vcftools_filt_chr1.log   # Standard output and error log
pwd; hostname; date
...
bcftools view --threads 16 -M 2 -i 'MIN(INFO/MQ)>30 && MIN(INFO/DP)>10 && F_MISSING<0.1' $VCF_CHR1 | sed 's/ENA|OY727105|OY727105\.1/chr1/g' | bgzip -c > $OUT_CHR1
