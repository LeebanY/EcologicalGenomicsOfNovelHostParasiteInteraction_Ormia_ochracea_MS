...
#SBATCH --output=vcftools_filt_chr2.log   # Standard output and error log
pwd; hostname; date
...
bcftools view --threads 16 -M 2 -i 'MIN(INFO/MQ)>30 && MIN(INFO/DP)>10 && F_MISSING<0.1' $VCF_CHR2 | sed 's/ENA|OY727106|OY727106\.1/chr2/g' | bgzip -c > $OUT_CHR2
